...
20 & Integer & Texture map count.\\ \hline
...
The body data contains the vertex, index, normal, texture map and attribute map
data, usually in a compressed form.

Please read the source code for details on the specific body data formats
(compressRAW.c, compressMG1.c and compressMG2.c).
