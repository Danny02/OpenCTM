...
procedure ctmTexCoordPrecision(AContext: TCTMcontext; ATexMap: TCTMenum; APrecision: TCTMfloat); stdcall;
...
function ctmAddTexMap(AContext: TCTMcontext; ATexCoords: PCTMfloat; AName: PChar; AFileName: PChar): TCTMenum; stdcall;
...
procedure ctmTexCoordPrecision; external DLLNAME;
...
function ctmAddTexMap; external DLLNAME;
